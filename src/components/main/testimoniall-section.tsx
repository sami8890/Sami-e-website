  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="space-y-4">
          ...
          <h3 className="text-xl text-zinc-300 mt-4 max-w-2xl mx-auto">
            Hear from clients who have experienced firsthand the quality and
            dedication we bring to every project.
          </h3>
        </div>
      </div>
            ...
            <div className="max-w-3xl mx-auto">
              {isLoading ? (
                ...
                <div className="bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-xl p-6 border border-zinc-800 shadow-lg transition-all duration-500 hover:shadow-green-500/10 backdrop-blur-sm">
                  {/* Large quote mark */}
                  <div className="absolute -top-5 left-6 text-5xl text-green-500/20 font-serif">
                    &quot;
                  </div>
                  ...
                  <div className="flex items-center justify-center">
                    ...
                    <div>
                      <div className="flex items-center">
                        ...
                        <span className="ml-2">
                          {getFlag(testimonials[activeIndex].country)}
                        </span>
                      </div>
                  ...
                  <div className="absolute -bottom-5 right-6 text-5xl text-green-500/20 font-serif rotate-180">
                    &quot;
                  </div>
                </div>
              )}
            ...
            {isLoading
              ...
              : displayedTestimonials.map((testimonial) => (
                  ...
                  >
                    ...
                    <div className="absolute top-3 right-3 text-xs text-green-500 opacity-50">
                      fiverr.
                    </div>
      ...
      <div className="relative max-w-3xl mx-auto mt-16 text-center px-6 py-8 bg-zinc-900 rounded-xl border border-zinc-800 shadow-lg transition-all duration-300">
        <div className="relative z-10">
          ...
          <p className="text-zinc-300 text-sm mb-6 max-w-xl mx-auto">
            Book a free consultation call to discuss your project needs and
            explore how we can help transform your digital presence.
          </p>
          <Link
         href="https://calendly.com/sami-gabol13/45min"
          ...
          >
            <span>Book a Free 45 Minutes Call</span>
            <svg
              className="w-4 h-4 ml-2"
              fill="none"
              stroke="currentColor"
      ...
      <div className="text-center mt-16 text-xs text-zinc-500 max-w-2xl mx-auto">
        <p>
          All testimonials are from verified clients who have worked with us on
          real projects.
        </p>
        <p className="mt-2">
