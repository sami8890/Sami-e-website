...
const projects: Project[] = [
...

  {
    ...
    category: "Portfolio",
    description: "A personal portfolio website built to showcase web development skills and projects.",
  ...
  {
    id: 4,
    name: "E-commerce Website (Furniture)",
    metric: "Complete furniture selling platform with full functionality",
  ...
  },
  {
    ...
    metric: "Practice demo website for a healthcare provider",
