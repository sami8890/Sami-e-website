...
export default function ProfessionalLogoMarquee() {
    ...
    const logos = [
        ...
        <svg key="react" className="w-10 h-10" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M50 70.8601C61.2611 70.8601 70.3836 61.7376 70.3836 50.4765C70.3836 39.2154 61.2611 30.0929 50 30.0929C38.7389 30.0929 29.6164 39.2154 29.6164 50.4765C29.6164 61.7376 38.7389 70.8601 50 70.8601Z"
                fill="#61DAFB"
            />
            <path
                d="M50 60.5765C55.6985 60.5765 60.3265 55.9486 60.3265 50.25C60.3265 44.5515 55.6985 39.9235 50 39.9235C44.3015 39.9235 39.6735 44.5515 39.6735 50.25C39.6735 55.9486 44.3015 60.5765 50 60.5765Z"
                fill="#61DAFB"
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M50 32.7235C69.2514 32.7235 85 40.6099 85 50.25C85 59.8901 69.2514 67.7765 50 67.7765C30.7486 67.7765 15 59.8901 15 50.25C15 40.6099 30.7486 32.7235 50 32.7235ZM50 42.7235C63.8071 42.7235 75 46.0633 75 50.25C75 54.4367 63.8071 57.7765 50 57.7765C36.1929 57.7765 25 54.4367 25 50.25C25 46.0633 36.1929 42.7235 50 42.7235Z"
                fill="#61DAFB"
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M28.0369 15.5765C37.1587 10.5099 52.8413 19.0098 67.5 37.4235C82.1587 55.8372 89.1587 75.7235 80.0369 80.7901C70.915 85.8568 55.2324 77.3568 40.5737 58.9431C25.915 40.5294 18.915 20.6431 28.0369 15.5765ZM40.5737 28.9431C50.2324 16.0098 61.915 7.5765 70.0369 12.5765C78.1587 17.5765 75.915 35.5294 66.2563 48.4627C56.5976 61.396 44.915 69.8294 36.7932 64.8294C28.6713 59.8294 30.915 41.8764 40.5737 28.9431Z"
                fill="#61DAFB"
            />
            <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M67.5 15.5765C76.6218 20.6431 73.6218 40.5294 58.9631 58.9431C44.3044 77.3568 28.6218 85.8568 19.5 80.7901C10.3782 75.7235 13.3782 55.8372 28.0369 37.4235C42.6956 19.0098 58.3782 10.5099 67.5 15.5765ZM58.9631 28.9431C68.6218 41.8764 70.8655 59.8294 62.7437 64.8294C54.6218 69.8294 42.9393 61.396 33.2806 48.4627C23.6218 35.5294 21.3782 17.5765 29.5 12.5765C37.6218 7.5765 49.3044 16.0098 58.9631 28.9431Z"
                fill="#61DAFB"
            />
        </svg>,
        ...
        <svg key="gsap" className="w-10 h-10" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                d="M88.89 33.33H66.67V11.11C66.67 5 61.67 0 55.56 0H11.11C5 0 0 5 0 11.11v77.78C0 95 5 100 11.11 100h77.78C95 100 100 95 100 88.89V44.44C100 38.33 95 33.33 88.89 33.33ZM55.56 77.78H22.22V22.22h33.34v55.56Z"
                fill="#88CE02"
            />
        </svg>,
    ...
    // Measure container width for animation
    useEffect(() => {
    ...
    // Create a single row of logos with enough duplicates for smooth scrolling
    const logoRow = () => {
        // Create enough duplicates to ensure continuous flow
        const allLogos = []
        // We need at least 2 complete sets for the animation to work properly
        for (let i = 0; i < 10; i++) {
            allLogos.push(...logos)
        }
    ...
    const marqueeVariants = {
        animate: {
            x: isPaused ? 0 : [0, -containerWidth / 2],
            transition: {
                x: {
