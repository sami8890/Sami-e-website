...
const techData: Record<string, { description: string; features: string[] }> = {
    react: {
        ...
        features: ["Component-Based", "Virtual DOM", "Unidirectional Data Flow", "JSX Support"],
    },
    next: {
        description: "The React Framework for Production",
        features: ["Hybrid SSR & SSG", "File-based Routing", "Built-in API Routes", "Image Optimization"],
    },
    typescript: {
        description: "JavaScript with syntax for types",
        features: ["Static Typing", "IDE Support", "ECMAScript Compatible", "Object-Oriented Features"],
    },
    tailwind: {
        description: "A utility-first CSS framework",
        features: ["Utility Classes", "JIT Engine", "Responsive Design", "Dark Mode"],
    },
}
...
export function TechPreview({ name }: { name: string }) {
    ...
    return (
        <HoverCard>
            ...
            <HoverCardContent className="w-80 bg-[#001F1B]/95 backdrop-blur-sm border-[#00D285]/20" align="start">
                <div className="flex justify-between space-x-4">
                    <div className="space-y-1">
                        <h4 className="text-sm font-semibold text-[#00D285]">{name.charAt(0).toUpperCase() + name.slice(1)}</h4>
